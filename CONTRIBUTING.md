...
Welcome to `learn_mqtt` contributor's guide.
...
If you experience bugs or general issues with `learn_mqtt`, please have a look
...
You can help improve `learn_mqtt` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`learn_mqtt` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `learn_mqtt`'s files. While this mechanism can
...
```
conda create -n learn_mqtt python=3 six virtualenv pytest pytest-cov
conda activate learn_mqtt
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/learn_mqtt.git
   cd learn_mqtt
   ```
...
5. Install [pre-commit]:
   ...
   `learn_mqtt` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/learn_mqtt
[issue tracker]: https://github.com/<USERNAME>/learn_mqtt/issues
